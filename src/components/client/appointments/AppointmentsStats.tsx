...
import { Calendar, Clock, CheckCircle, AlertCircle, TrendingUp, Users, Star, Award, Crown, Trophy, Medal, Flame, Sparkles, Zap, Target, Heart, Eye, Bookmark, BarChart3 } from 'lucide-react';
