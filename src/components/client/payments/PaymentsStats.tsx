...
import { DollarSign, TrendingUp, CreditCard, Calendar, Award, Crown, Trophy, Medal, Flame, Sparkles, Zap, Target, Heart, Star, Eye, Bookmark, BarChart3, Activity, Gift, Rocket, Diamond } from 'lucide-react';
