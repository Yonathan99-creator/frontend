...
import { Eye, Star, Clock, DollarSign, MapPin, Calendar, User, Heart, Bookmark, Share2, MessageCircle, Phone, Mail, CheckCircle, Award, Crown, Trophy, Medal, Flame, Sparkles, Zap, Target, Gift, Rocket, Diamond, ThumbsUp, Users, TrendingUp, BarChart3, Activity, Settings, Bell, Download, Edit, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Performance Metrics</h3>
                <p className="text-gray-600 dark:text-gray-400">Projected service performance</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { label: 'Projected Bookings', value: '45/month', icon: Calendar, color: 'from-blue-500 to-cyan-600' },
                { label: 'Revenue Potential', value: `$${(serviceData.price * 45).toLocaleString()}`, icon: TrendingUp, color: 'from-green-500 to-emerald-600' },
                { label: 'Market Position', value: 'Premium', icon: Crown, color: 'from-purple-500 to-pink-600' },
                { label: 'Competition', value: 'Low', icon: Target, color: 'from-orange-500 to-red-600' }
              ].map((metric, index) => {
                ...
                return (
                  <div 
                    ...
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${metric.color} flex items-center justify-center shadow-lg group-hover:rotate-12 group-hover:scale-110 transition-transform duration-300 mb-4`}>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Optimization Suggestions</h3>
                <p className="text-gray-600 dark:text-gray-400">Improve your service performance</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  type: 'success',
                  title: 'Great pricing strategy!',
                  description: 'Your price is competitive and positioned well in the market.',
                  icon: CheckCircle,
                ...
                },
                {
                  ...
                  description: 'Services with 3+ images get 40% more bookings.',
                  icon: Camera,
                ...
                {
                  type: 'warning',
                  title: 'Consider adding aftercare instructions',
                  description: 'Detailed aftercare increases client satisfaction and repeat bookings.',
                  icon: Heart,
                ...
                return (
                  <div 
                    key={index}
                    className={`flex items-start space-x-4 p-4 ${suggestion.bgColor} rounded-2xl border border-gray-200/50 dark:border-gray-600/50 hover:shadow-lg transition-all duration-300 hover:scale-105 group animate-in slide-in-from-left-4 duration-1000`}
                    style={{ animationDelay: `${index * 150}ms` }}
                  >
                    <Icon className={`w-6 h-6 ${suggestion.color} mt-1 group-hover:scale-110 transition-transform duration-300`} />
                    <div>
