...
const ServicesHeader: React.FC = () => {
  ...
  const quickActions = [
    { icon: Plus, label: 'Add Service', color: 'from-blue-500 to-cyan-600' },
    { icon: Settings, label: 'Manage Pricing', color: 'from-green-500 to-emerald-600' },
  ...
  return (
    <div className="relative bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 animate-in slide-in-from-top-4 duration-1000">
      {/* Background Pattern */}
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
          <div className="flex items-center space-x-6">
            <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border-2 border-white/30 shadow-2xl hover:bg-white/30 transition-all duration-300 hover:scale-110 hover:rotate-12 group">
              <Scissors className="w-10 h-10 text-white group-hover:scale-110 transition-transform duration-300" />
            </div>
            <div>
              <h1 className="text-4xl font-bold mb-2 animate-in slide-in-from-left-4 duration-1000 text-white">My Services</h1>
              <p className="text-purple-100 text-lg animate-in slide-in-from-left-4 duration-1000 delay-200">Manage your service offerings and pricing</p>
              <div className="flex items-center space-x-4 mt-3">
                <div className="flex items-center space-x-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm hover:bg-white/20 transition-all duration-300 animate-in slide-in-from-left-4 duration-1000 delay-300">
                  ...
                  <span className="font-semibold text-white">Premium Services</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm hover:bg-white/20 transition-all duration-300 animate-in slide-in-from-left-4 duration-1000 delay-500">
                  ...
                  <span className="font-semibold text-white">12 Active Services</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            <button className="group flex items-center space-x-3 px-8 py-4 bg-white/20 backdrop-blur-sm rounded-2xl hover:bg-white/30 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 animate-in slide-in-from-right-4 duration-1000 text-white">
              ...
              <span className="font-bold text-lg">Add New Service</span>
            </button>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm font-bold text-purple-100 mb-1">{stat.label}</p>
                <p className="text-xs text-purple-200">{stat.change}</p>
              </div>
            );
          })}
        </div>
