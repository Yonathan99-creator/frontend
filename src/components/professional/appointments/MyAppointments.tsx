...
import { Calendar, Sparkles, Crown, Trophy, Medal, Flame, Zap, Target, Award, Heart, Star, Eye, Bookmark, ThumbsUp, Gift, Rocket, Diamond } from 'lucide-react';
...
const MyAppointments: React.FC = () => {
  ...
  const appointments = [
    ...
    },
    {
      ...
      startTime: new Date(2025, 0, 20, 14, 30),
      endTime: new Date(2025, 0, 20, 16, 30),
      service: 'Full Color',
    ...
    },
    {
      ...
      endTime: new Date(2025, 0, 21, 9, 45),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 animate-in slide-in-from-top-4 duration-1000">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mt-2">
                Manage your schedule and client appointments with style
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {[
              { icon: Crown, label: 'Top Professional', color: 'from-yellow-500 to-orange-600', description: 'Ranked #1 this month' },
              { icon: Trophy, label: '500+ Appointments', color: 'from-blue-500 to-purple-600', description: 'Milestone achieved' },
              { icon: Medal, label: '5 Star Rating', color: 'from-green-500 to-emerald-600', description: 'Client satisfaction' },
              { icon: Flame, label: 'Trending Stylist', color: 'from-red-500 to-pink-600', description: 'Most booked' }
            ].map((badge, index) => {
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8 hover:shadow-3xl transition-all duration-500 animate-in slide-in-from-bottom-4 duration-1000 delay-800 mt-8">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Manage appointments efficiently</p>
            </div>
          </div>
        ...
        <div className="fixed bottom-8 right-8 z-50">
          <button className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 active:scale-95 group animate-bounce">
            <Calendar className="w-8 h-8 mx-auto group-hover:scale-110 transition-transform duration-300" />
          </button>
        </div>
